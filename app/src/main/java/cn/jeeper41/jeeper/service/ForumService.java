...
public class ForumService {
    ...
    public void getDetailPostList(String topicId,final ForumCallBack callBack){
        HttpHelper.sendGet(Global.DETAILPOSTLIST_URL+"?topicid="+topicId, new Callback() {
            @Override
            public void onFailure(Request request, IOException e) {
                callBack.onFormFinish(null);
            }
    ...
    public void sendReply(String topicId,final ForumCallBack callBack){
        HttpHelper.sendGet(Global.SENDREPLY_URL, new Callback() {
            @Override
            public void onFailure(Request request, IOException e) {
                callBack.onFormFinish(null);
            }
